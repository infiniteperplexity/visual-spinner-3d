...
recipes.add({movename: "Three-Petal Anti-Spin Flower", recipe: "flower", spin: ANTISPIN, petals: 3, orient: THREE, entry: THREE, duration: 1, extend: 1, direction: CLOCKWISE, mode: DIAMOND, plane: WALL, pivot_angle: THREE, pivot_radius: 0});	
...
recipes.add({movename: "Linear Extension", orient: THREE, entry: THREE, recipe: "linex", petals: 0, mode: DIAMOND, spin: INSPIN, direction: CLOCKWISE, duration: 1, plane: WALL, pivot_angle: THREE, pivot_radius: 0});
recipes.add({movename: "Linear Isolation", orient: THREE, entry: THREE, recipe: "linex", petals: 2, mode: DIAMOND, spin: INSPIN, direction: CLOCKWISE, duration: 1, plane: WALL, pivot_angle: THREE, pivot_radius: 0});
recipes.add({movename: "Iso-Bend Toroid", recipe: "toroid", orient: THREE, entry: THREE, mode: DIAMOND, direction: CLOCKWISE, pitch: FORWARD, harmonics: 4, bend: ISOBEND, duration: 1, extend: 1, plane: WALL, pivot_angle: THREE, pivot_radius: 0});
recipes.add({movename: "Anti-Bend Toroid", recipe: "toroid", orient: THREE, entry: THREE, mode: DIAMOND, direction: CLOCKWISE, pitch: FORWARD, harmonics: 2, bend: ANTIBEND, duration: 1, extend: 1, plane: WALL, pivot_angle: THREE, pivot_radius: 0});
recipes.add({movename: "Linearized Iso-Bend", recipe: "isobend", orient: THREE, entry: THREE, mode: DIAMOND, direction: CLOCKWISE, pitch: FORWARD, harmonics: 4, duration: 1, plane: WALL, pivot_angle: THREE, pivot_radius: 0});
recipes.add({movename: "Linearized Anti-Bend", recipe: "antibend", orient: THREE, entry: THREE, mode: DIAMOND, direction: CLOCKWISE, pitch: FORWARD, harmonics: 4, duration: 1, plane: WALL, pivot_angle: THREE, pivot_radius: 0});
recipes.add({movename: "Tapedeck Toroid", recipe: "tapedeck", orient: THREE, entry: THREE, direction: CLOCKWISE, pitch: FORWARD, duration: 1, plane: WALL, pivot_angle: THREE, pivot_radius: 0});
